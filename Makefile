...
AVRDUDE_FLAGS = -V -F
AVRDUDE_FLAGS += -C /etc/avrdude/avrdude.conf #$(ARDUINO_PATH)/hardware/tools/avrdude.conf 
AVRDUDE_FLAGS += -p $(MCU)
...
COMMON_FLAGS += -I. 
COMMON_FLAGS += -I$(ARDUINO_PATH)hardware/arduino/cores/arduino -I$(ARDUINO_PATH)hardware/arduino/variants/standard/
